...
function coverageMarkup(){
  ...
  return `<section class="coverage" aria-labelledby="coverage-heading"><div class="row"><div><span class="eyebrow">${eyebrow}</span><h2 id="coverage-heading">Where your wallet earns extra</h2></div></div><p class="timeline-intro">${intro}</p>
